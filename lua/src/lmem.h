...
#define luaM_newvector(L, n, t) cast(t*, luaM_malloc(L, cast(lu_mem, n) * cast(lu_mem, sizeof(t))))
...
#define luaM_reallocvector(L, v, oldn, n, t) \
    ((v) = cast(t*, luaM_realloc(L, v, cast(lu_mem, oldn) * cast(lu_mem, sizeof(t)), cast(lu_mem, n) * cast(lu_mem, sizeof(t)))))
