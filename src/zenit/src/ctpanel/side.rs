                ...
                .show(ui, |ui| {
                    ...
                    // TODO: clean up frame time graph
                    {
                        ...
                        for frame in engine.frame_profiler.frames.iter().take(total_samples) {
                            ...
                            shapes.push(egui::Shape::LineSegment {
                                ...
                                stroke: egui::Stroke::new(1.0, engine.frame_profiler.render_color),
                            });
                            y -= render_height;
                            ...
                            shapes.push(egui::Shape::LineSegment {
                                ...
                                stroke: egui::Stroke::new(1.0, engine.frame_profiler.game_color),
                            });
                            y -= game_height;

                            shapes.push(egui::Shape::LineSegment {
                                points: [egui::pos2(base.x, y), egui::pos2(base.x, y - ui_height)],
                    ...
                    ui.indent("last_frame", |ui| {
                        egui::Grid::new("timing_info").show(ui, |ui| {
                            ...
                            ui.e_faint_label(format!("({:.02} %)", percentage(last.render_time)));
